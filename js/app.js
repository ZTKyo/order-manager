    ...
    return `
        ...
        <div style="display:flex;gap:16px;margin-bottom:20px;flex-wrap:wrap;">
            ...
            <div style="flex:1;min-width:280px;">
                ...
                ${order.viewLink ? `<div style="padding:8px 0;border-bottom:1px solid #e5e7eb;font-size:13px;display:flex;justify-content:space-between;align-items:center;gap:8px;"><span style="color:#6b7280;">查看链接</span><span style="display:flex;align-items:center;gap:6px;"><a href="${escapeHtml(order.viewLink)}" target="_blank" style="color:#2563eb;text-decoration:none;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:220px;display:inline-block;vertical-align:middle;">↗ 打开</a><button class="btn btn-secondary" style="padding:2px 8px;font-size:11px;" onclick="copyText('${escapeHtml(order.viewLink)}')">📋 复制</button></span></div>`:''}
                ${order.sourceLink ? `<div style="padding:8px 0;border-bottom:1px solid #e5e7eb;font-size:13px;display:flex;justify-content:space-between;align-items:center;gap:8px;"><span style="color:#6b7280;">源文件链接</span><span style="display:flex;align-items:center;gap:6px;"><a href="${escapeHtml(order.sourceLink)}" target="_blank" style="color:#2563eb;text-decoration:none;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:220px;display:inline-block;vertical-align:middle;">↗ 打开</a><button class="btn btn-secondary" style="padding:2px 8px;font-size:11px;" onclick="copyText('${escapeHtml(order.sourceLink)}')">📋 复制</button></span></div>`:''}
